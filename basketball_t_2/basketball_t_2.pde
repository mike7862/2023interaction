...
void mousePressed() {
  ...
  if (game3Completed && mouseX > buttonW+325 && mouseX < 485 && mouseY > buttonR+460 && mouseY < 535) {
    // 第三關回首頁
    State = 0;
